...
sp = dlib.shape_predictor(os.getcwd()+'/Models/shape_predictor_5_face_landmarks.dat')
facerec = dlib.face_recognition_model_v1(os.getcwd()+'/Models/dlib_face_recognition_resnet_model_v1.dat')
